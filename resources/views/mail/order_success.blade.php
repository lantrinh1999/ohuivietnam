                                        ...
                                        <tbody>
                                            <tr>
                                                <td bgcolor="#FFFFFF" style="padding:0" valign="top" width="100%">
                                                    ...
                                                    trị đơn hàng là {{ohui_number_format($data['total'])}}</div>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p
                                                        ...
                                                        Rất vui thông báo đơn hàng #{{$code_order}} của quý khách đã được
                                                    ...
                                                    <h3
                                                        ...
                                                        Thông tin đơn hàng #{{$code_order}} <span
                                                        ...
                                                        <tfoot
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" style="padding:5px 9px">
                                                                    <span>{{ohui_number_format($data['total'])}}</span></td>
                                                            </tr>
                                                            ...
                                                            <tr bgcolor="#eee">
                                                                ...
                                                                <td align="right" style="padding:7px 9px">
                                                                    <strong><big><span>{{ohui_number_format($data['total'])}}</span> </big> </strong></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
