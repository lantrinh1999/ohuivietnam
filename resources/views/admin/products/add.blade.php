        ...
        <div class="col-md-8">
            <form id="infomation">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" id="" cols="40" rows="20"></textarea>
                </div>
                <div class="form-group">
                    <label for="">Chi tiết sản phẩm</label>
                    <textarea class="form-control" id="content" name="content" id="" cols="50" rows="30"></textarea>
                </div>
            </form>
            <hr>
            ...
            <div class="panel panel-default">
                <div style="display:flex; justify-content:space-between" class="panel-heading">
                    ...
                    <div style="padding: 8px; width: 60%: display:flex: justify-content: space-around" class="">
                        <span style="cursor: pointer" class="clickable panel-collapsed"><i
                                class="glyphicon glyphicon-chevron-up"></i></span>
                        <span style="cursor: pointer" class=""><i class="remove-variant glyphicon glyphicon-remove"></i></span>
                    </div>
                </div>
