...
<div class="box">
    <div class="box-header">
        <div class="col-xs-12 ">
            ...
            <a class="btn btn-sm btn-primary btn-flat" href="{{route('admin.posts.add')}}">Thêm bài viết mới</a>
            </div>
            ...
            columns: [
                ...
                {data: null,title :'Tên bài viết',name : 'name', render: function ( data, type, row ) {
                    ...
                    <div class="div-action"><a  class="btn-edit"
                        href="{{ url('admin/posts/edit/') }}/${data.id}">Sửa</a>
                ...
                if (action == 'delete') {
                    ...
                    if (data.length != 0) {
                        swal({
                            ...
                            .then((willDelete) => {
                                    if (willDelete) {
                                        ajaxFunc2("{{route('admin.posts.deleteMulti')}}", formData);
