    ...
    <div class="box-body">
        <form  id="form-edit" action="">
            ...
            <div class="form-group">
                ...
                <input value="{{ $attribute_value->name }}" class="form-control" type="text" name="name" id="name" placeholder="">
                <span id="error-name" class="error error-name text-danger text-bold"></span>
            </div>
            <div class="form-group">
                <label for="">Slug</label>
                <input class="form-control" type="text" value="{{ $attribute_value->slug }}" name="slug" id="slug" placeholder="abc-xyz">
                <span id="error-slug" class="error error-slug text-danger text-bold"></span>
            </div>
            <div class="form-group">
                <label for="">Giá trị</label>
                <input class="form-control" type="text" value="{{ $attribute_value->value }}" name="slug" id="slug">
